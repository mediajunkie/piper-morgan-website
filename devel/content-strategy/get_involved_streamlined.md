# "Get Involved" Page - Streamlined Newsletter-First Approach

## Implementation Guidance for Claude Code

### Content Strategy
**Goal**: Replace 5 competing CTAs with newsletter-first approach using Newsletter page benefits and social proof
**Structure**: Primary newsletter section, content streams, future opportunities, expandable "more ways" section
...
<Hero
  ...
  subheadline="Get weekly insights into our breakthrough discoveries, behind-the-scenes development updates, and practical frameworks you can apply to your own AI collaboration work. Join 576+ PM professionals learning systematic AI collaboration."
  primaryCTA={{
...
### Primary Newsletter Section (Replace multiple CTA sections)
```jsx
    ...
    <div className="max-w-4xl mx-auto">
      <div className="text-center mb-12">
        <h2 className="text-4xl font-bold text-text-dark mb-4">
          Join 576+ PM Professionals Learning Systematic Excellence
        </h2>
...
### Current Content Streams (Simplified from existing)
```jsx
...
### Future Content & More Engagement (Simplified)
```jsx
{/* Growing Piper Morgan + More Ways to Engage */}
...
### Bottom Line Section (Simplified)
```jsx
{/* The Bottom Line */}
...
- **Single primary CTA**: Newsletter signup with enhanced benefits from Newsletter page
- **Social proof**: "576+ professionals" prominently featured throughout
- **Progressive disclosure**: "More ways to engage" as expandable section, not competing CTAs
- **Clear hierarchy**: Newsletter → Content streams → Future opportunities → Advanced engagement

### Technical Requirements
1. **301 Redirect**: Set up `/newsletter` → `/get-involved#newsletter`
2. **Anchor linking**: Ensure smooth scroll to #newsletter section
3. **Enhanced ConvertKit tagging**: Add `source-get-involved` tag
4. **Details/summary accessibility**: Ensure keyboard navigation works properly
...
### Content Benefits
- **Focused conversion path**: Single newsletter CTA vs. 5 competing options
- **Preserved Newsletter page value**: All benefits, social proof, and value props integrated
- **Professional UX**: Clear hierarchy reduces decision paralysis
- **Scalable engagement**: Easy to expand "More ways" section as opportunities develop

This approach prioritizes newsletter conversion while maintaining all engagement pathways through progressive disclosure, exactly matching your UX lead's recommendation for professional audience conversion optimization.