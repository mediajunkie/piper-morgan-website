...
const variantClasses = {
  ...
  outline: [
    ...
    'text-primary-teal-text dark:text-primary-teal',
    'border-2',
    'border-primary-teal-text dark:border-primary-teal',
    'hover:bg-primary-teal-text dark:hover:bg-primary-teal',
    'hover:text-white',
    'focus:ring-primary-teal-text dark:focus:ring-primary-teal',
    'shadow-component',
    'hover:shadow-component-hover',
    'hover:-translate-y-0.5',
    'font-medium',
