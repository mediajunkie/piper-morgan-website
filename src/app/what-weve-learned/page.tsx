        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto">
            ...
            <div className="bg-primary-teal/10 p-8 rounded-lg mb-8">
              <div className="grid md:grid-cols-2 gap-8">
                <div>
                  <h3 className="text-lg font-semibold text-text-dark mb-3">What everyone assumes</h3>
                  <p className="text-text-light mb-4">
                    Checking AI work takes extra time and slows down the "AI speed advantage."
                  </p>
                </div>
                <div>
                  <h3 className="text-lg font-semibold text-text-dark mb-3">What we discovered</h3>
                  <p className="text-text-light mb-4">
              ...
              <div className="border-t border-primary-teal/20 pt-6 mt-6">
                <h3 className="text-lg font-semibold text-text-dark mb-3">The evidence</h3>
                <p className="text-text-light mb-4">
                ...
                <div className="bg-white p-4 rounded-lg mt-4">
                  <p className="text-text-dark font-medium">
                    <strong>Strategic insight for leaders</strong>: AI tools that encourage verification aren't slower - they're more sustainable. Budget for systematic checking up front, save time on debugging later.
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8 space-y-0">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="space-y-4">
                  <div>
                    <h4 className="font-semibold text-text-dark mb-2">What everyone assumes</h4>
                  ...
                  <div>
                    <h4 className="font-semibold text-text-dark mb-2">What we discovered</h4>
                    <p className="text-text-light text-sm mb-4">
                  ...
                  <div className="bg-primary-teal/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-text-dark mb-2">Strategic insight</h4>
          ...
          <div className="max-w-4xl mx-auto space-y-12">
            ...
            <div className="bg-gradient-to-r from-primary-teal/5 to-primary-orange/5 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                <p className="text-text-light">
                  <strong>The evidence</strong>: Our test-driven development patterns work better with AI than without because AI excels at systematic implementation of clear specifications. We catch more edge cases and handle more scenarios because AI doesn't get bored with thoroughness.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary-orange/5 to-primary-teal/5 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                <p className="text-text-light">
                  <strong>The evidence</strong>: Our biggest project risks come from misaligned objectives or unclear requirements, not technical implementation failures. AI makes it easier to build the wrong thing efficiently.
                </p>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-primary-teal/5 to-primary-orange/5 p-8 rounded-lg">
              ...
              <div className="mt-6 p-4 bg-white rounded-lg">
                <p className="text-text-light">
                  <strong>The evidence</strong>: We make different mistakes now - more strategic misalignment, fewer technical bugs. But we catch and correct strategic mistakes much faster because AI enables rapid iteration on approach, not just implementation.
                </p>
              </div>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-8">
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-primary-teal/10 p-4 rounded-lg">
                    <h4 className="font-semibold text-text-dark mb-2">The evidence</h4>
                    ...
                    <p className="text-text-dark font-medium text-sm">
                      <strong>Strategic insight</strong>: Invest in process transparency and documentation systems. The ability to show how AI-augmented decisions were made becomes a strategic differentiator.
                    </p>
                  </div>
                </div>
              </div>
              ...
              <div className="bg-white p-8 rounded-lg shadow-sm">
                ...
                <div className="space-y-4">
                  ...
                  <div className="bg-primary-orange/10 p-4 rounded-lg">
                    ...
                    <p className="text-text-dark font-medium text-sm">
                      <strong>Strategic insight</strong>: Plan for AI coordination systems, not just AI tool rollouts. The organizations that scale AI successfully will be those that invest in collaboration design, not just capability deployment.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              <div className="bg-primary-teal/10 p-8 rounded-lg">
                ...
                <ul className="space-y-3 text-text-light">
                  <li><strong>Start with verification habits</strong>: Build systematic checking into your AI workflow from day one. Quality-first approaches pay dividends immediately.</li>
                  <li><strong>Focus on problem definition</strong>: The biggest AI wins come from clear specifications, not clever prompting. Invest in requirements thinking.</li>
                  <li><strong>Plan for coordination</strong>: Even if you're working individually, design your AI workflow for eventual team collaboration.</li>
                </ul>
              </div>
              ...
              <div className="bg-primary-orange/10 p-8 rounded-lg">
                ...
                <ul className="space-y-3 text-text-light">
                  <li><strong>Audit for systematic approaches</strong>: Which of your current AI uses follow repeatable patterns? Which are ad hoc? Systematize what's working.</li>
                  <li><strong>Evaluate your tool portfolio</strong>: Are you trying to make one AI tool do everything, or are you strategically deploying different tools for different tasks?</li>
                  <li><strong>Document strategic decisions</strong>: Capture the "why" behind AI approaches, not just the "how." Future you (and your team) will thank you.</li>
                </ul>
              </div>
              ...
              <div className="bg-primary-teal/10 p-8 rounded-lg">
                ...
                <ul className="space-y-3 text-text-light">
                  <li><strong>Invest in process design</strong>: The biggest AI ROI comes from systematic approaches to AI collaboration, not just tool deployment.</li>
                  <li><strong>Plan for skill evolution</strong>: Budget for strategic thinking development, not just AI tool training. The bottleneck is alignment quality, not implementation capacity.</li>
                  <li><strong>Build transparency systems</strong>: Stakeholder confidence in AI-augmented work comes from visible systematic processes, not just impressive outputs.</li>
                </ul>
              </div>
            </div>
          </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="prose max-w-none text-lg text-text-light space-y-6">
              <p>
                Three months of intensive AI development taught us that the future isn't human vs. AI or even human + AI. It's <strong>systematic human intelligence orchestrating systematic AI capabilities</strong>.
              </p>
              <p>
            ...
            <div className="mt-12 space-y-4">
              <p className="text-lg text-text-light">
                <strong>Want to see how these insights apply in practice?</strong> Follow the <a href="https://medium.com/building-piper-morgan" className="text-primary-teal hover:underline" target="_blank" rel="noopener noreferrer">Building Piper Morgan series</a> where we document ongoing discoveries - including the inevitable mistakes and course corrections.
              </p>
              <p className="text-lg text-text-light">
                <strong>Ready to test these patterns in your own work?</strong> <a href="/get-involved" className="text-primary-teal hover:underline">Get involved</a> - we're always looking for perspectives from other practitioners who are building systematically with AI.
              </p>
            </div>
          </div>
        </div>
